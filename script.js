...
const DATA = {
  projects:[
    ...
    { id:"privacy-pdf-editor",
      en:{ title:"Privacy PDF Editor — Self-hosted PDF toolkit with Ghost Vault", tags:["Python","FastAPI","ChaCha20","Docker","Raspberry Pi","Privacy"],
           desc:"LAN-only PDF editor with an encrypted vault, plausible deniability, and zero cloud dependency — running on a Raspberry Pi 4.",
           points:["PDF editor: merge, reorder, watermark, anonymize (XMP + JS removal), compress, unlock — pages render 100% locally via PDF.js.","Ghost Vault: ChaCha20-Poly1305 AEAD encryption, scrypt KDF (n=2¹⁵) — each file supports multiple passwords, each opening a different document.","Duress mode: secondary password returns a decoy PDF and cryptographically shreds the real cell (fsync).","No CDN, no Node.js required — all JS libs vendored locally, frontend served by Python's http.server."],
           links:[{href:"/articles/privacy-pdf-editor",icon:"fas fa-file-alt",label:"Read article"},{href:"https://github.com/cherifon/Privacy-PDF-Editor",icon:"fab fa-github",label:"GitHub Repo"}] },
      fr:{ title:"Privacy PDF Editor — Suite PDF auto-hébergée avec Ghost Vault", tags:["Python","FastAPI","ChaCha20","Docker","Raspberry Pi","Privacy"],
           desc:"Éditeur PDF en LAN uniquement avec vault chiffré, déni plausible et zéro dépendance cloud — tourne sur un Raspberry Pi 4.",
           points:["Éditeur PDF : fusionner, réordonner, filigrane, anonymiser (suppression XMP + JS), compresser, déverrouiller — pages rendues à 100% localement via PDF.js.","Ghost Vault : chiffrement ChaCha20-Poly1305 AEAD, KDF scrypt (n=2¹⁵) — chaque fichier supporte plusieurs mots de passe, chacun ouvrant un document différent.","Mode contrainte : un mot de passe secondaire retourne un PDF leurre et détruit cryptographiquement la cellule réelle (fsync).","Pas de CDN, pas de Node.js requis — toutes les librairies JS vendorisées localement, frontend servi par http.server Python."],
           links:[{href:"/articles/privacy-pdf-editor",icon:"fas fa-file-alt",label:"Lire l'article"},{href:"https://github.com/cherifon/Privacy-PDF-Editor",icon:"fab fa-github",label:"Dépôt GitHub"}] },
    },
    { id:"tournoi",
  ...
  articles:[
    ...
    { id:"privacy-pdf-editor",
      en:{ title:"Privacy PDF Editor — Self-hosted PDF toolkit with Ghost Vault on Raspberry Pi 4",
           date:"2026-06-18", readTime:"10 min read",
           tags:["Python","FastAPI","ChaCha20","Docker","Raspberry Pi","Privacy","Cryptography"],
           desc:"A self-hosted, LAN-only PDF editor with an encrypted vault, plausible deniability, and zero cloud dependency.",
           href:"/articles/privacy-pdf-editor" },
      fr:{ title:"Privacy PDF Editor — Suite PDF auto-hébergée avec Ghost Vault sur Raspberry Pi 4",
           date:"2026-06-18", readTime:"10 min de lecture",
           tags:["Python","FastAPI","ChaCha20","Docker","Raspberry Pi","Privacy","Cryptographie"],
           desc:"Un éditeur PDF auto-hébergé en LAN uniquement, avec vault chiffré, déni plausible et zéro dépendance cloud.",
           href:"/articles/privacy-pdf-editor" },
    },
  ],
  certs:[
